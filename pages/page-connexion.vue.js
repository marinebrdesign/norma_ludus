...
<div class="centrer">
    <div id="container">
        <form id="connexion" action="verification.php" method="POST">
            <label for="id"></label>
            <input type="text" id="id" placeholder="E-mail ou identifiant" name="username" required>

            <label for="mdp"></label>
            <input type="password" id="mdp" placeholder="Mot de passe" name="password" required>
            <router-link to="mdp-oublie">Mot de passe oublié ?</router-link>
            <div class="connexion">
